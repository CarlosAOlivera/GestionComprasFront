...
hide: any;
  ...
  iniciarFormulario() {
    this.myForm = this.formBuilder.group({           
          // IdUsuario field is removed as it's generated by the backend
      ...
      CorreoElectronico: ['', [Validators.required, this.emailValidator(), Validators.minLength(5), Validators.maxLength(30)]],
